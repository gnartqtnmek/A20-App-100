...
All env vars live here. Anything reading ``os.getenv`` directly outside this
module is a code smell — funnel it through ``get_settings()``.
"""
...
class Settings(BaseSettings):
    ...
    # ---- CORS ----
    # Comma-separated list in env, e.g. "http://localhost:3000,https://lms.example.com"
